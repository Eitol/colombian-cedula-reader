...
class Localities
{
     ...
     */
    public static function getLocalityByCode(string $departmentCode, string $municipalityCode): ?Location
    {
        foreach (Localities::$localities as $row) {
            if ($row[Localities::$depCodeIndex] == $departmentCode && $row[Localities::$munCodeIndex] == $municipalityCode) {
                return new Location(
                    "CO",
                    $row[Localities::$depNameIndex],
                    $row[Localities::$munNameIndex],
                    $row[Localities::$depCodeIndex],
                    $row[Localities::$munCodeIndex]
                );
            }
        }
        return null;
    ...
    /** @var int */
    private static $munNameIndex = 2;
    /** @var int */
    private static $depNameIndex = 3;

    /** @var int */
    private static $munCodeIndex = 0;
    /** @var int */
    private static $depCodeIndex = 1;
